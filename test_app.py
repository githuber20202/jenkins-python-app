...
def test_add():
    """Test add function"""
    assert app1.add(2, 3) == 5, "2 + 3 should equal 5"
    assert app1.add(-1, 1) == 0, "-1 + 1 should equal 0"
    assert app1.add(0, 0) == 0, "0 + 0 should equal 0"
    assert app1.add(100, 200) == 300, "100 + 200 should equal 300"
    print("✅ test_add PASSED")
    return True

def test_multiply():
    """Test multiply function"""
    assert app1.multiply(2, 3) == 6, "2 × 3 should equal 6"
    assert app1.multiply(-2, 3) == -6, "-2 × 3 should equal -6"
    assert app1.multiply(0, 100) == 0, "0 × 100 should equal 0"
    assert app1.multiply(5, 5) == 25, "5 × 5 should equal 25"
    print("✅ test_multiply PASSED")
    return True

def test_get_app_info():
    """Test get_app_info function"""
    info = app1.get_app_info()
